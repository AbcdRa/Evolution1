...
//        {
//            playerMananger.interactablePlayer.UnselectCard();
//        }
...
//        {
//            if (so.idOwner != playerMananger.interactablePlayer.id) return;
//            UpdateSelectionableObject(so);
...
//                playerMananger.interactablePlayer.SelectCard(card);
            
//        } else if(so.GetSpecification() == SelectionableObjectSpecification.PropCard)
//        {
//            UpdateSelectionableObject(so);
//            if (Input.GetMouseButton(0))
//                GameMananger.instance.InteractProp(playerMananger.interactablePlayer, card);
...
//                if (Input.GetMouseButtonDown(0))
//                {
//                    playerMananger.interactablePlayer.AddCardToSpot(animalSpot);
//                }
...
//                if (Input.GetMouseButton(0))
//                {
//                    playerMananger.interactablePlayer.InteractWithFood(foodMananger);
//                }
//            }
